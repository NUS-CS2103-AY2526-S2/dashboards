...
<panel type="seamless">
<div slot="header"><md><span class="badge rounded-pill bg-danger">Troubleshooting</span> Why are my _issues_ not being detected?</md></div>
...
<panel type="seamless">
<div slot="header"><md><span class="badge rounded-pill bg-danger">Troubleshooting</span> Why are my _PRs_ not being detected?</md></div>
...
<panel type="seamless">
<div slot="header"><md><span class="badge rounded-pill bg-danger">Troubleshooting</span> The required change was committed/pushed -- why is it not being detected?</md></div>
